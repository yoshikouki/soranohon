...
export const books: Record<string, Book> = {
  ...
  "59521_71684": {
    ...
    coverImage: paths.images.books.keyVisual("59521_71684"),
  ...
  "18334_11947": {
    ...
    bibliographyRaw: `底本：「日本の神話と十大昔話」講談社学術文庫、講談社\n\n1983（昭和58）年5月10日第1刷発行\n1992（平成4）年4月20日第14刷発行\n入力：鈴木厚司\n校正：大久保ゆう\n2003年8月2日作成\n青空文庫作成ファイル：\nこのファイルは、インターネットの図書館、青空文庫（http://www.aozora.gr.jp/）で作られました。入力、校正、制作にあたったのは、ボランティアの皆さんです。`,
    aozoraBunkoUrl: "https://www.aozora.gr.jp/cards/000329/card18334.html",
    mdx: () => import("./18334_11947.mdx"),
  },
  "42308_17916": {
    id: "42308_17916",
    title: "白雪姫",
